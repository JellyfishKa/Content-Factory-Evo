"""Pydantic contracts between pipeline stages (T1.3).

This is the contract handed to the teammate as the scaffold for
researcher.py / writer.py / seo.py / validators.py.
"""
